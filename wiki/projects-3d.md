...
| 3 | [BOT Builders (photo cut) — abandoned 8-shot 3D short from the team's own photos](#fll_champions) | 2026-09-23 | superseded by fll_bot_builders (delivered 2026-09-24). 8 stills picked and 8 clips rendered 2026-09-23; never trimmed, upscaled or cut. Files kept in raw/clips/fll/. | FLUX.2 [klein] 9B 1024x576 | LTX-2.3 22B [distilled] 1.1 10 min | Light Adventure | `—` | — |
...
## BOT Builders (photo cut) — abandoned 8-shot 3D short from the team's own photos {#fll_champions}

- **Date**: 2026-09-23 · **Status**: superseded by fll_bot_builders (delivered 2026-09-24). 8 stills picked and 8 clips rendered 2026-09-23; never trimmed, upscaled or cut. Files kept in raw/clips/fll/. · **Draw Things project**: `none — draw-things-cli via scripts/film_run.py`
- **Files** (`raw/clips/`): `fll/stills/*.png`, `fll/clips/*.mov`, `fll/final/fll_champions_3840x2160.mp4`
- **Notes**: Kevin is the team's coach; consent for all five children confirmed by him 2026-09-23. 3D-animated look chosen over photoreal precisely because five recurring child faces are the heaviest identity load attempted here — stylised faces hold through LTX motion. No on-screen text. Source photos are real: every shot still is a klein edit of a photo (identity from pixels), and the two invented shots (s6, s7) chain off approved stills. Superseded 2026-09-24 by the comic-derived fll_bot_builders film, which covers the same team. Kept because the approach differs and the parts are reusable: every still here is a klein edit of a real photo at --strength 1.0 (the garage build table, the farm gate, the logs, the team portrait), where the comic film works from drawn panels. Two rules came out of it — see the run notes.
...
| Music | Light Adventure — 331music, Pixabay (cdn.pixabay.com/download/audio/2026/08/26/audio_f1cf54e839.mp3), 2:12 — downloaded, never used |
