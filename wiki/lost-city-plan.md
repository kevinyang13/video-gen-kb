...
| 14 | **Escape** — clear of the city on the plain, skyline collapsing behind | fixed | creature still and breathing, rider looks back; all motion in the distance | creature + city |

Cheap shots first: 2, 3, 5, 7 have no hero face and simple motion — render them to test the look before the tracking shots.

**Story (v2, 2026-09-22)**: arrival and exploration (1–3, 7), life with the creature (9–11), then the city comes down and the rider escapes (13–14). The collapse gives the film an ending that needs no dialogue and no face.
