...
**Last updated**: 2026-09-22 (shot 15 rift coda; LTX production settings in §3c; escape ending, shot 14 restaged as a landscape total collapse, creature enlarged after a motion-bleed failure; per-scene prompts in [[projects]])
...
## 6. Shot list (v3 — 10 s clips; 1–3, 7–10 and 14 shot, 15a–c rendering, 13 written)
...
| 15a ✅ | **The crack** — a jagged tear splits the sky over the ruined city | fixed, very slow push in | the tear widens, clouds peel back, first winged shapes slip out | city (ruined); no ground creature in frame |
| 15b ✅ | **Exodus** — the flock pours out of the tear | tilt down with them | dense stream of winged reptiles fanning apart, shadows over rubble | chained: first frame = last frame of 15a |
| 15c ✅ | **The circling** — the flock wheels above the dead city | fixed very wide | one slow unbroken circle of winged reptiles, crack flaring behind | flock + city |

Cheap shots first: 2, 3, 5, 7 have no hero face and simple motion — render them to test the look before the tracking shots.

**Story (v2, 2026-09-22)**: arrival and exploration (1–3, 7), life with the creature (9–11), then the city comes down and the rider escapes (13–14). Shot 14 was the last frame of the film: a distant landscape view where every spire collapses until nothing is left standing. **Coda (v3, 2026-09-22)**: shot 15 goes back to the dead city — a crack tears open in the sky above the ruins and winged reptiles pour out of it and circle the rubble, three chained 10 s clips cut into one 30 s piece. The rider never appears, so nothing has to stay consistent except the city. The collapse gives the film an ending that needs no dialogue and no face.
