...
- **YouTube**: [youtu.be/9YlHr5mehaA](https://youtu.be/9YlHr5mehaA) *(scenes 1–10 compilation)*

<div class="yt"><iframe src="https://www.youtube.com/embed/9YlHr5mehaA" title="Lost City — hyper-real rider on a raptor-dragon entering jungle ruins" loading="lazy" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
...
#### s14 — Escape — distant landscape, every spire falls until the skyline is empty

- **Engine**: LTX 1024x576 x257 (10.3 s)
- **Note**: Landscape framing: the collapse is the subject, the creature is scale. Slow foreground + violent distance = the stable s10 pattern, and a small subject cannot drift visibly. Pace the destruction so the last tower falls by ~8 s and the final second is an empty dust skyline — the film's last frame. Keep the creature large enough to read (roughly a sixth of the frame width) or klein loses the legs.

*Still prompt*

> Cinematic film still, anamorphic 35mm, extreme wide landscape view from a high grassy ridge, muted colours, low contrast, subtle film grain. Vast valley vista: an open plain of grass and ferns in the foreground, dark jungle canopy in the middle distance, and filling the far distance the whole lost city of colossal eroded sandstone spires and ziggurat towers, collapsing all at once — towers shearing and toppling, entire spires breaking apart into falling blocks, immense dust plumes rising and merging into a low grey wall that spreads across the valley floor, debris drifting through shafts of hard sunlight. Small in the lower left foreground, seen in side profile on the ridge crest and dwarfed by the landscape, a large quadrupedal raptor-like reptile mount, no wings, slate-grey ridged hide, long neck with a bony horn crest, leather saddle with reins and a brown satchel, standing on two heavy hind legs and two smaller forelegs, head up and turned back toward the city. On its back a lone rider sitting upright and looking back, grey-green hooded cloak, brown leather jerkin, tan trousers, tall boots. Deep depth of field, huge sense of scale, tiny figures against an enormous collapsing skyline, Layered atmospheric perspective, photorealistic, highly detailed, natural overcast light with warm sun breaks.

*Video prompt*

> Fixed camera, extreme wide landscape. In the foreground the creature stands still on the ridge, sides heaving with deep breaths, head raised and turned back, tail swaying slowly; the rider sits upright and watches, cloak moving in the wind. In the far distance the city comes down completely: spire after spire shears, buckles and falls in slow heavy arcs, the tall towers going last, each collapse throwing up a new dust plume until the plumes merge into one grey wall that rolls outward across the valley; by the end nothing is left standing on the skyline, only a flat bank of dust over rubble where the city was. Grass and ferns bend as the dust wind reaches the ridge. Distant thunderous collapse, grinding stone, rising wind, heavy animal breathing, no music.
