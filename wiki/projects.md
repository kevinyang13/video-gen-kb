...
#### s14 — Escape — clear of the city, ruins falling behind

- **Engine**: LTX 1024x576 x257 (10.3 s)
- **Note**: Slow foreground + violent background = the stable pattern from s10. Creature holds still, all motion is in the distance.

*Still prompt*

> Cinematic film still, anamorphic 35mm, eye-level side view, muted colours, low contrast, subtle film grain. An open grassy plain outside the lost city at the mouth of the jungle, ferns and scattered carved blocks underfoot, hazy daylight. In the foreground on the right, standing still in side profile and breathing hard, a large quadrupedal raptor-like reptile mount, no wings, slate-grey ridged hide, long neck with a bony horn crest, small amber eyes, leather saddle with reins and a brown satchel, head up and turned back toward the city, standing on two heavy hind legs and two smaller forelegs. On its back a lone rider sitting upright in the saddle, turned to look back, grey-green hooded cloak settling, brown leather jerkin, tan trousers, tall boots. Filling the distance behind them, the whole lost city is collapsing: eroded sandstone spires and ziggurat towers toppling and breaking apart, vast plumes of dust rising between them, debris falling through shafts of sunlight, the skyline half-swallowed by dust. Deep depth of field, Layered atmospheric perspective, photorealistic, highly detailed, natural overcast light with warm sun breaks.

*Video prompt*

> Fixed camera. The creature stands still in the foreground, sides heaving with deep breaths, head raised and turned back toward the city, tail swaying slowly; the rider sits upright and watches, cloak settling in the wind. In the distance behind them the spires and towers keep collapsing one after another, whole sections shearing away and falling in slow heavy arcs, dust plumes billowing upward and rolling outward across the plain toward the camera, debris drifting down through the light. Grass and ferns bend in the dust wind. Distant thunderous collapse, grinding stone, wind, heavy animal breathing, no music.
