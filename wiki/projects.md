...
| 10 | [Lost City — hyper-real rider on a raptor-dragon entering jungle ruins](#lost_city) | 2026-09-21 | in progress — clips at 4K+music: s2, s3, s7, s8, s10; s9 trimmed (4.6 s, drift after); s11 stills rejected (klein duplicates the creature); s12 not started | FLUX.2 [klein] 9B 1280x768 | Wan 2.2 High Noise I2V (8-bit S) + Low Noise refiner 10% (proven) — or LTX-2.3 22B distilled 1.1 (experiment L1: 8 steps, CFG 1, 1280x736, 121 f @ 25 fps, audio) 49 min | Mystical orchestral theme with ancient flute | `—` | — |
