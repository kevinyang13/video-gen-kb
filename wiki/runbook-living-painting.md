...
| Translucent double image (ghosting) on a big moving subject | too much subject translation asked of 4 steps | keep refiner 10% (50% → noise with the Lightning LoRA); remove camera moves and "across the frame" from the prompt; motion = wing beats / hair / cloth only |
